...
public class DocumentTypeMapper {
    ...
    public static List<DocumentTypeResponse>modelToDocumentTypeResponseList(List<DocumentType> documentTypes) {
        /*List<DocumentTypeResponse>documentTypeResponseList = null;
    ...
    public static DocumentType createDocumentTypeRequestToDocumentType(CreateDocumentTypeRequest request) {
